    ...
    methods
        ...
        function obj = SummaryView(model, varargin)
            ...
            label = uilabel(obj.Grid, ...
                "Text", ["Use this app to compute your net income based on your recurring deductions. You can add", ...
                "pre-tax and post-tax deductions. The values of National Insurance and tax will be computed", ...
                "based on the gross income, after pre-tax and optional pension deductions have been subtracted."], ...
                "FontSize", 13, ...
